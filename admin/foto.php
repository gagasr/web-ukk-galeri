        ...
        <div class="card mt-2">
          ...
          <div class="card-body">
            <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
              ...
              <input type="" name="judulfoto" class="form-control" required>
      ...
      <div class="col-md-8">
        <div class="card mt-2">
          <div class="card-header">
            <div class="card-body">Data Galeri Foto</div>
            <table class="table">
              <thead>
                <tr>
                  <th>#</th>
                  ...
                  <tr>
                    ...
                    <td>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="../config/aksi_foto.php" method="POST" enctype="multipart/form-data">
                                ...
                                <label class="form-label">Judul Foto</label>
                                <input type="" name="judulfoto" <?php echo $data['judulfoto'] ?> class="form-control"
                                  required>
                                <label class="form-label">Deskripsi</label>
                      ...
                      <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                        data-bs-target="#hapus<?php echo $data['fotoid'] ?>"><i class="bi bi-trash"></i></button>
                          ...
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <form action="../config/aksi_foto.php" method="POST">
                                <input type="hidden" name="fotoid" value="<?php echo $data['fotoid'] ?>">
                                Anda yakin ingin menghapus foto ini <strong>
                                  <?php echo $data['judulfoto'] ?>
                                </strong> ?
                            </div>
                            <div class="modal-footer">
